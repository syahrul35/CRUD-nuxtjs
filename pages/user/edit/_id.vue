...
export default {
    ...
    mounted(){
        ...
        .then(response => {
            this.users.first_name = response.data.data.first_name,
            this.users.last_name = response.data.data.last_name,
            this.users.phone = response.data.data.phone,
            this.users.address = response.data.data.address,
            this.users.email = response.data.data.email,
            this.users.password = response.data.data.password
        })
    },
